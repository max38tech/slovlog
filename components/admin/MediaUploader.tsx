    ...
    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-slovenia-blue/20 focus:border-slovenia-blue"
          />
        </div>
      ...
      <div
        ...
        className={`border-2 border-dashed rounded-2xl p-8 text-center cursor-pointer transition-all duration-150 flex flex-col items-center justify-center min-h-[160px] ${
          dragActive
            ? "border-slovenia-blue bg-slovenia-blue/5 scale-[0.99]"
            : "border-slate-300 hover:border-slovenia-blue/60 bg-slate-50/50 hover:bg-slate-50"
      ...
      >
        ...
        {isPending ? (
          <div className="flex flex-col items-center gap-2">
            <Loader2 className="w-8 h-8 animate-spin text-slovenia-blue" />
            <p className="text-sm font-medium text-slate-700">Uploading photo to Supabase...</p>
          </div>
        ) : (
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 rounded-xl bg-slovenia-blue/10 text-slovenia-blue flex items-center justify-center">
